...
def plot_multistate_model(q: np.ndarray,observed_counts: dict[str,int],path: Path):
...
def main():
    ...
    plot_multistate_model(q,prep['transitions_by_pair'],FIGURES_DIR/'10_multistate_model_diagram.pdf')
